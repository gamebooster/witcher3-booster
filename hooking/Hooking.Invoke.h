...
class function_stub_base {
 ...
 public:
  inline void SetFunctionAddress(void* address) { m_functionAddress = address; }
};
...
class StubInitFunction : public HookFunctionBase {
 ...
 public:
  ...
  virtual void Run() { m_stub->SetFunctionAddress(m_function()); }
};
...
class thiscall_stub_ : public function_stub_base {
 ...
 public:
  ...
  inline TRet operator()(Args... args) {
    return reinterpret_cast<TRet(__thiscall*)(Args...)>(m_functionAddress)(
        args...);
  }
};
...
class cdecl_stub_ : public function_stub_base {
 ...
 public:
  ...
  inline TRet operator()(Args... args) {
    return reinterpret_cast<TRet(__cdecl*)(Args...)>(m_functionAddress)(
        args...);
  }
};
}
...
class thiscall_stub<TRet(Args...)>
 ...
 public:
  thiscall_stub(void* (*getter)()) : thiscall_stub_(getter) {}
};
...
class cdecl_stub<TRet(Args...)> : public details::cdecl_stub_<TRet, Args...> {
 public:
  cdecl_stub(void* (*getter)()) : cdecl_stub_(getter) {}
};
}